...
import { addDiaryEntry } from '../../store/slices/healthDiarySlice';
import AddPhotoHeader from '../../components/Pets/AddPhotoHeader';
import CustomInput from '../../components/CustomInput';
import PlusSVG from '../../assets/paw/PlusSVG';

export default function NewEntryProceduresScreen({ route, navigation }) {
    const { newDiaryData } = route.params || {};
    ...
    const handleDonePress = () => {
        const newDiaryEntry = {
            ...
            title: newDiaryData?.reason || 'New Entry',
            petName: newDiaryData?.petName,
            petImage: newDiaryData?.petImage || null,
            dateTime: newDiaryData?.dateTime || '',
            doctorName: newDiaryData?.doctorName || '',
            weight: newDiaryData?.weight || '',
            reason: newDiaryData?.reason || '',
            temperature: newDiaryData?.temperature || '',
            diagnosticResults: newDiaryData?.diagnosticResults || '',
                        ...
                        <View key={index} style={styles.procedureContainer}>
                            ...
                            >
                                <Text
                                    style={[
                                        styles.dateTimeText,
                                        procedure.dateTime ? { color: '#FFFFFF' } : {},
                                    ]}
                                >
